...
public static class ProjectWindowShowFullAssetName
{
    ...
    static bool EnableMultilineDisplay => EditorPrefs.GetBool(PrefKey_EnableMultilineDisplay, true);
    static bool EnableCamelCaseSpacing => EditorPrefs.GetBool(PrefKey_EnableCamelCaseSpacing, true);
